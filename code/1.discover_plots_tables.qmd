...
setdiff(list_gene_data, list_gene_fin
```
...
```{r}
gtsave(stx_gt_table, "2025-01-10_stx_gt_table.png", here::here("results"))
```
...
unique(data$`Disease..only.human.isolates.`)
unique(data$`Import..only.non.human.isolates.`)
  # select("Accession.Number", "Isolate.ID", 
  #        "Country", "Institute",
  #        "Year.Isolation", 
  #        "Source", "Source.Group", "Source.Subgroup", "Source.Comment", 
