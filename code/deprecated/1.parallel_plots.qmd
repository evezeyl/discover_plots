...
library(purrr)
library(svglite)
here::i_am("code/1.parallel_plots.qmd")
```

> This script is not used anymore - did all the plots in 1.discover_plots_tables.qmd
...
THIS IS TO BE CHECKED : **Homoegeneizing NAs** *Ask for treatment*
...
# Do not use anymore 
> See 1.discover_plots_tables.qmd
...
Export the plot Curious seems that gemo_fit_text does not work nice with export in gg... Export manually and works best
...
#        units = "cm",
#        width = 30, height = 10)
ggsave(filename = here::here("results", "2025-05-12_global_parallel_plot2.png"),
       plot = global_parallel_plot,
       dpi = 300,
       units = "cm",
       width = 30, height = 10) 
